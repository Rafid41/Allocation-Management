...
def modification_view(request):
    ...
    if request.method == "POST":
        ...
        if action == "go_to_modify":
            ...
            if allocation_id:
                return redirect("Project_App_Modification:modification_options", allocation_id=allocation_id)
            ...
            if allocation_id:
                ...
                heading_run = heading.add_run(f'Modified Project Allocation: Allocation Number - {allocation.allocation_no}')
    ...
    return render(request, "Project_Templates/Project_App_Modification/modification.html", {
