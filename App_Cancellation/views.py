...
def cancellation_view(request):
    ...
    if request.method == "POST":
        ...
        if action == "cancel_allocation":
            ...
            if allocation_id:
                ...
                return redirect("App_Cancellation:cancellation")
            ...
            if allocation_id:
                ...
                heading_run = heading.add_run(f'Cancelled Allocation: Allocation Number - {allocation.allocation_no}')
                ...
                response["Content-Disposition"] = f'attachment; filename="Cancelled_Allocation_{allocation.allocation_no}.docx"'
                doc_io = io.BytesIO()
                doc.save(doc_io)
                doc_io.seek(0)
    ...
    return render(request, "App_Cancellation/cancellation.html", {
